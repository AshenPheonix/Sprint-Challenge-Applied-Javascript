...
1. What is the DOM?
    ...
    The DOM is a model that javascript uses to store how an HTML page is created from the ground up, it looks a lot like an ancestry tree.

2. What is an event?

    A response to something the user or webpage does.

3. What is an event listener?

    Something that listens for an event to occur so it can preform an action.
...
5. What is a component?
    ...
    A component is a concept involving taking a DOM element and converting its functionality to javascript so you can control it with more precision and make it possible to re-use the code much easier
